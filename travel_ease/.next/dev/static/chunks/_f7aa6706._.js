...
const useBookingStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persist"])((set)=>({
        ...
        updateFlight: (id, updatedFlight)=>set((state)=>({
                    flights: state.flights.map((f)=>f.id === id ? {
                            ...f,
                            ...updatedFlight
                        } : f)
                })),
        ...
        updateHotel: (id, updatedHotel)=>set((state)=>({
                    hotels: state.hotels.map((h)=>h.id === id ? {
                            ...h,
                            ...updatedHotel
                        } : h)
                })),
...
function AdminPage() {
    _s();
    const { flights: storeFlights, hotels: storeHotels, addFlight, updateFlight, deleteFlight, addHotel, updateHotel, deleteHotel } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$bookingStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBookingStore"])();
    const flights = storeFlights.length > 0 ? storeFlights : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockFlights"];
    const hotels = storeHotels.length > 0 ? storeHotels : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockHotels"];
    ...
    const handleUpdateFlight = ()=>{
        if (editingFlight) {
            updateFlight(editingFlight.id, editingFlight);
    ...
    const handleAddHotel = ()=>{
        const newHotel = {
            ...
            price: hotelForm.price || 0,
            rating: hotelForm.rating || 0,
            amenities: typeof hotelForm.amenities === 'string' ? hotelForm.amenities.split(',').map((a)=>a.trim()) : hotelForm.amenities || [],
            image: hotelForm.image || 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800'
        };
        addHotel(newHotel);
    ...
    const handleUpdateHotel = ()=>{
        if (editingHotel) {
            updateHotel(editingHotel.id, editingHotel);
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                            ...
                                            value: typeof hotelForm.amenities === 'string' ? hotelForm.amenities : hotelForm.amenities?.join(', '),
                                            onChange: (e)=>setHotelForm({
                                                    ...hotelForm,
...
_s(AdminPage, "mZP7bLgAUyg+dfGcI9Wh5BA1Rwo=", false, function() {
    return [
...
//# sourceMappingURL=_f7aa6706._.js.map